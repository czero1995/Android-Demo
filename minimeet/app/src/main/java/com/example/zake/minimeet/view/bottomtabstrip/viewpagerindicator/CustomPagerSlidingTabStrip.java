package com.example.zake.minimeet.view.bottomtabstrip.viewpagerindicator;
...
public class CustomPagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int tabBackgroundResId = R.mipmap.ic_launcher;
...
//    public void showDot(int index,boolean isShow) {
//        RelativeLayout tab0 = (RelativeLayout) tabsContainer.getChildAt(index);
//        View labelTV0=  tab0.findViewById(R.id.tv_unread_label);
//        if (labelTV0==null)
//            return;
//        if (isShow) {
//            labelTV0.setVisibility(View.VISIBLE);
//        } else {
//            labelTV0.setVisibility(View.GONE);
//        }
