...
public class MyAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageView drawiv = (ImageView) layout.findViewById(R.id.list_draw);
        ...
        String urldraw = cursor.getString(cursor.getColumnIndex("draw"));
        ...
        imgiv.setImageBitmap(getImageThumbnail(urldraw,200,200));
        return layout;
