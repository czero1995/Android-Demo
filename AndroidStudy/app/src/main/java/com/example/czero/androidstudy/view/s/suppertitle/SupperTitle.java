package com.example.czero.androidstudy.view.s.suppertitle;
...
public class SupperTitle extends RelativeLayout {
    ...
    private void initView(Context mContext, AttributeSet mAttrs) {
        ...
        mLeftImage = (ImageView) layout.findViewById(R.id.left_iv);
        //左边布局
        mLeftAll = (LinearLayout) layout.findViewById(R.id.left_all);
    ...
    public void setLeftImagePadding(int left, int top, int right, int bottom) {
        if (mLeftImage == null) return;
        mLeftImage.setVisibility(VISIBLE);
//        mLeftImage.setPadding((int) ScreenUtils.dpToPx(BaseApplication.getContext(), left), (int) ScreenUtils.dpToPx(BaseApplication.getContext(), top), (int) ScreenUtils.dpToPx(BaseApplication.getContext(), right), (int) ScreenUtils.dpToPx(BaseApplication.getContext(), bottom));
    }
...
//            supper_title.setPadding((int) ScreenUtils.dpToPx(BaseApplication.getContext(), left), (int) ScreenUtils.dpToPx(BaseApplication.getContext(), top), (int) ScreenUtils.dpToPx(BaseApplication.getContext(), right), (int) ScreenUtils.dpToPx(BaseApplication.getContext(), bottom));
    ...
    public void setOnLeftClickListener(OnClickListener listener) {
        if (mLeftAll == null) return;
        mLeftAll.setVisibility(VISIBLE);
        mLeftAll.setOnClickListener(listener);
    }
