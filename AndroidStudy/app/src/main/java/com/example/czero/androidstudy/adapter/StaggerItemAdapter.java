...
import com.example.czero.androidstudy.bean.StaggerItem;
...
public class StaggerItemAdapter extends BaseAdapter {
    ...
    private void initData() {
        int[] imageSource = {R.drawable.ic_activity, R.drawable.ic_activity, R.drawable.ic_activity, R.drawable.ic_activity,
                R.drawable.ic_activity, R.drawable.ic_activity, R.drawable.ic_activity, R.drawable.ic_activity,
        ...
        int[] thumbImageArray = {R.drawable.ic_activity, R.drawable.ic_activity, R.drawable.ic_activity, R.drawable.ic_activity, R.drawable.ic_activity};
