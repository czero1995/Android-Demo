...
public class ShanZhiQuanListAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			shanZhiQuanItemHolders.tv_img= (ImageView) convertView.findViewById(R.id.userimg);
			shanZhiQuanItemHolders.img_amusetalk= (ImageView) convertView.findViewById(R.id.imgamusetalk);
		...
		if (user ==null){
			shanZhiQuanItemHolders.tv_img.setImageResource(R.drawable.ic_app);
		}else {
//			Glide.with(mContext).load(mShanZhiQuan.get(position).getUserimage()).error(R.drawable.ic_app).transform(new GlideCircleTransform(mContext)).into(shanZhiQuanItemHolders.tv_img);
		}
//		try {
