...
public class ServerActivity extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        urls.add("http://bmob-cdn-1826.b0.upaiyun.com/2016/08/06/00e9e9f9408d3b0280027e6637da7c7a.jpg");
        urls.add("http://119.29.121.145/welcome.jpg");
        urls.add("http://bmob-cdn-1826.b0.upaiyun.com/2016/06/04/2d5b449640b5a6cc8087bdc6afd9097f.png");
        urls.add("http://bmob-cdn-1826.b0.upaiyun.com/2016/06/02/00a98ed94019be4b80d4d9d951da92f4.jpg");
        urls.add("http://119.29.121.145/welcome.jpg");
        ...
        bannerLayout.setOnBannerItemClickListener(new BannerLayout.OnBannerItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                switch (position) {
                    case 0:
                      Intent i  = new Intent(getContext(),NewPeopleSZYL.class);
                        startActivity(i);
                        break;
//                    case 1:
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.secondtrade:
                CircularAnimUtil.startActivity((Activity) getContext(), SecondTradeActivity.class, v, R.color.gray_bg);
                break;
            case R.id.lostfound:
