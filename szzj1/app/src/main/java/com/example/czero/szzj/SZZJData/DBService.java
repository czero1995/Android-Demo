...
public class DBService {
    ...
    public DBService()
    {
        db = SQLiteDatabase.openDatabase("/data/data/com.example.czero.szzj/databases/question.db", null, SQLiteDatabase.OPEN_READWRITE);
    ...
    public List<Question> getQuestions()
    {
        ...
        if(cursor.getCount() > 0)
        {
            ...
            for(int i = 0; i < count; i++)
            {
                ...
                question.explaination = cursor.getString(cursor.getColumnIndex("explaintion"));
