...
public class TourListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.tour_list_item, null);
			tourItemHolder = new TourItemHolder();
			tourItemHolder.tvTourType = (TextView) convertView
					.findViewById(R.id.tv_tourtype);
			...
			tourItemHolder.tvTourPhone = (TextView) convertView
					.findViewById(R.id.tv_tourphone);
		...
		tourItemHolder.tvTourType.setText(mtour.get(position).getType());
		tourItemHolder.tvTourName.setText(mtour.get(position).getName());
		tourItemHolder.tvTourPhone.setText(mtour.get(position).getPhone());
		tourItemHolder.tvTourContent.setText(mtour.get(position).getContent());
		tourItemHolder.tvTourTime.setText(mtour.get(position).getTourtime());
		tourItemHolder.tvTime.setText(mtour.get(position).getCreatedAt());
